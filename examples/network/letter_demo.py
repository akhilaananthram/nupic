...
from nupic.encoders import MultiEncoder, LetterEncoder

_VERBOSITY = 0  # how chatty the demo should be
_SEED = 1956  # the random seed used throughout
_INPUT_FILE_PATH = "letters.csv"
_OUTPUT_PATH = "letter-demo-output.csv"
_NUM_RECORDS = 26
...
def createEncoder():
  ...
  letter_encoder = LetterEncoder(name="letter")

  encoder = MultiEncoder()
  encoder.addEncoder("letter", letter_encoder)
